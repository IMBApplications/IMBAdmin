                ...
                [
                {
                    ...
                    click: function() {
                        ...
                        $.post(ajaxEntry, {
                            ...
                            ajaxmethod: "addPropertyToMyGames",
...
<div id="ImbaAjaxUsersMyGamesModalProperty" title="Eigenschaft hinzuf&uuml;gen">
    ...
    <div id="MyGamesTab">
        ...
        <div>
            ...
            <ul>
                ...
                <li>{$property.property} <span onclick="javascript: showAddGameProperty('{$game.id}', '{$property.id}', '{$property.property}');" style="cursor: pointer;"><b>hinzuf&uuml;gen</b></span></li>
                {/foreach}
            </ul>
